...
vpath %.cpp ./srcs/:./srcs/basics/:./srcs/taag/:./srcs/taag/basics:./srcs/gui:./srcs/taag/menu_player_editor:./srcs/taag/menu_spell_editor:./srcs/taag/menu_monster_editor:./srcs/taag/menu_map_editor
